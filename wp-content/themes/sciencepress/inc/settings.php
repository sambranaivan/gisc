<?php
    ...
    $settings = array(
		...
		'slider'=>array(
			...
			'content'=>array(
				'txt'=>array(
					'type'=>'p','name'=>'','value'=>'Recommended thumbnail size is 986x408px'
				),
				'source'=>array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'663','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
					'type'=>'text','name'=>'imgheight','value'=>'189','ttl'=>'Loop image height', 'hint'=>'Featured images height (px)'
				),
				'imgpos'=>array(
